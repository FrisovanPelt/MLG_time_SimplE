...
class Trainer:
    def __init__(self, dataset, args):
        ...
        self.model = SimplE(dataset.num_ent(), dataset.num_rel(), dataset.num_time(), args.emb_dim, self.device)
    ...
    def train(self):
        ...
        for epoch in range(1, self.args.ne + 1):
            ...
            while not last_batch:
                h, r, t, time, l = self.dataset.next_batch(
